				...
				<div class="data_view">
					<mySwiper :data="list" :type="3"
						...
						<template #default="scope">
							<div class="data_item animation_box" @click.stop="detailClick(scope.row)">
								<div class="data_img_box" v-if="scope.row.picture && scope.row.picture.substr(0,4)=='http'">
									<img class="data_img" :src="scope.row.picture" >
								</div>
								<div class="data_img_box" v-else>
									<img class="data_img" :src="scope.row.picture?$config.url + scope.row.picture.split(',')[0]:''"
										>
								</div>
								<div class="data_content">
									<div class="data_title">{{scope.row.name}}</div>
								</div>
							</div>
						</template>
					</mySwiper>
