<template>
	<div class="app-contain" :style='{"padding":"0","margin":"40px auto 60px","overflow":"hidden","borderRadius":"0px","background":"none","width":"80%","position":"relative"}'>
