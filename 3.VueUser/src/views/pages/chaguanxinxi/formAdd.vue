...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"80%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="13">
					<el-form-item label="茶馆名称" prop="chaguanmingcheng">
						<el-input class="list_inp" v-model="form.chaguanmingcheng" placeholder="茶馆名称"
							 type="text" 							:readonly="!isAdd||disabledForm.chaguanmingcheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="13">
					<el-form-item label="茶位数" prop="chaweishu">
						<el-input class="list_inp" v-model.number="form.chaweishu" placeholder="茶位数"
							 type="text" 							:readonly="!isAdd||disabledForm.chaweishu?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="13">
					<el-form-item label="可容纳人数" prop="kerongnarenshu">
						<el-input class="list_inp" v-model.number="form.kerongnarenshu" placeholder="可容纳人数"
							 type="text" 							:readonly="!isAdd||disabledForm.kerongnarenshu?true:false" />
					</el-form-item>
				</el-col>
...
<script setup>
	...
	const disabledForm = ref({
		chaguanmingcheng : false,
		dizhi : false,
		chaweishu : false,
		kerongnarenshu : false,
		fengmian : false,
		jiage : false,
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='chaguanmingcheng'){
					form.value.chaguanmingcheng = row[x];
					disabledForm.value.chaguanmingcheng = true;
					continue;
				}
				if(x=='dizhi'){
				...
				if(x=='chaweishu'){
					form.value.chaweishu = row[x];
					disabledForm.value.chaweishu = true;
					continue;
				}
				if(x=='kerongnarenshu'){
					form.value.kerongnarenshu = row[x];
					disabledForm.value.kerongnarenshu = true;
					continue;
				}
				if(x=='fengmian'){
		...
		context?.$http({
			...
			if(json.hasOwnProperty('chaguanmingcheng') && context?.$toolUtil.storageGet("frontRole")!="管理员"){
				form.value.chaguanmingcheng = json.chaguanmingcheng
				disabledForm.value.chaguanmingcheng = true;
			}
