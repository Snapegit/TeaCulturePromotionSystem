			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="茶叶详情" prop="chayexiangqing">
						<editor class="list_editor" :value="form.chayexiangqing" placeholder="请输入茶叶详情" :readonly="!isAdd||disabledForm.chayexiangqing?true:false"
							@change="(e)=>editorChange(e,'chayexiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.chayexiangqing = res.data.data.chayexiangqing.replace(reg,'../../../cl3018432/file');
