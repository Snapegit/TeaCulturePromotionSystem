			...
			<el-row>
				...
				<el-col :span="13">
					<el-form-item label="活动类型" prop="huodongleixing">
						<el-input class="list_inp" v-model="form.huodongleixing" placeholder="活动类型"
							 type="text" 							:readonly="!isAdd||disabledForm.huodongleixing?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="13">
					<el-form-item label="活动时间" prop="huodongshijian">
						<el-input class="list_inp" v-model="form.huodongshijian" placeholder="活动时间"
							 type="text" 							:readonly="!isAdd||disabledForm.huodongshijian?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="13">
					<el-form-item label="活动详情" prop="huodongxiangqing">
						<el-input class="list_inp" v-model="form.huodongxiangqing" placeholder="活动详情"
							 type="text" 							:readonly="!isAdd||disabledForm.huodongxiangqing?true:false" />
					</el-form-item>
				</el-col>
